        ...
        <div class="container">
            <div class="container-formcontainer">
                ...
                <form class="container-formcontainer-form">
                    ...
                    <label>Vehicle</label>
                            <input type="radio" id="motorcycle" @change="onChangeRadio($event)" name="motorcycle" class="motorcycle" value="motorcycle" v-model="vecicle">
                            <input type="radio" id="bicycle" @change="onChangeRadio($event)" name="bicycle" class="bicycle" value="bicycle" v-model="vehicle">
                            <input type="radio" id="runner" @change="onChangeRadio($event)" name="runner" class="runner" value="runner" v-model="vehicle">
                    </br>
